...
Alex<-read.csv("weather_data/Alexander_Lucas/Alexander_Lucas_bloom_1958_2019.csv")
...
temperature<-read.csv("weather_data/Alexander_Lucas/TMaxTMin1958-2019_patched.csv")
