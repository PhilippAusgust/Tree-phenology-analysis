...
>
The dataset `Zuelpich_hourly` contains one temperature value for each hour for the year 2019. It is important to note that the hourly temperature value represents the mean value for the respective hour. The dataset begins in February.
...
# save_temperature_scenarios(temps_1980,
#                                "weather_data/Leszno_weather_raw",
#                                paste0("temps_1980"))
# 
# temps_1980 = read.table("weather_data/Leszno_weather_raw/temps_1980_1_1980.csv", 
#                         header = TRUE,sep =",")
